...
class MediaFileValidatorTest {
    ...
    void validateFileSize_shouldThrowWhenSizeExceedsLimit(long size, long maxBytes) {
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> MediaFileValidator.validateFileSize(size, maxBytes));
    ...
    void validateMimeType_shouldRejectWhenMimeIsNullOrBlank() {
        IllegalArgumentException exception1 =
                assertThrows(IllegalArgumentException.class, () -> MediaFileValidator.validateMimeType(null, List.of("image/png")));
        assertTrue(exception1.getMessage().toLowerCase().contains("mime"));

        IllegalArgumentException exception2 =
                assertThrows(IllegalArgumentException.class, () -> MediaFileValidator.validateMimeType("  ", List.of("image/png")));
    ...
    void validateMimeType_shouldRejectWhenMimeIsNotAllowed() {
        ...
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> MediaFileValidator.validateMimeType("image/gif", allowedMimeTypes));
